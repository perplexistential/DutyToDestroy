...
#define PLATFORM_SET_BACKGROUND_COLOR(n) void n(float r, float g, float b, float a)
typedef PLATFORM_SET_BACKGROUND_COLOR(PlatformSetBackgroundColorFn);
...
{
  // Draw
  PlatformSetBackgroundColorFn *PlatformSetBackgroundColor;
